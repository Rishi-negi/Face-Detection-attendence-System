...
def contact():
    mess._show(title='Contact Admin', message="Please contact us on : 'rishinegi27062001@gmail.com' ")
...
head2 = tk.Label(frame2, text="                        New Registrations                                ", fg="white",bg="blue" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                        Already Registered Students                      ", fg="white",bg="blue" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Enter ID",width=10  ,height=1  ,fg="black"  ,bg="#FFFFFF" ,font=('times', 17, ' bold ') )
lbl.place(x=30, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=10  ,fg="black"  ,bg="#FFFFFF" ,font=('times', 17, ' bold '))
...
trackImg = tk.Button(frame1, text="Mark Attendance", command=TrackImages  ,fg="black"  ,bg="#FFFFFF"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trackImg.place(x=30,y=50)
quitWindow = tk.Button(frame1, text="EXIT", command=window.destroy  ,fg="black"  ,bg="#FFFFFF"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
